...
著者は、提案手法の有効性を検証するため、以下の4つのリサーチクエスチョン（RQ）を設定し、客観的なデータに基づいて評価を行っています。
...
Alipayの約2,700万ユーザーを対象とした5日間の本番A/Bテストを実施しました。
全体として **CTR +3.19%, CVR +1.08%** という統計的に有意で巨大なビジネスインパクトを達成しました。
